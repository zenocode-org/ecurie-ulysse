...
import jMmonShetlad from "../../../images/elevage/jMmonShetlad.jpg";
import installs01 from "../../../images/installations/installs_01.jpg";

export const prestationsFeaturesData = {
  features: [
    {
    ...
    },
    {
      ...
      description:
        "NOUVEAU ! Les Écuries viennent d'obtenir l'agrément ÉDUCATION NATIONALE. Offrez aux écoliers une activité au grand air, au contact de la nature et des poneys ! Toute l'année ou pour les sorties de fin d'année, nous accueillons vos groupes d'enfants dans un écrin de verdure.",
      visual: scolaire01,
    },
    {
      title: "Services",
